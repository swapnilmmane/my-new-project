...
// Within both commands, we rely on the deployed GraphQL API (my-full-stack-application/api) and its stack
...
// - `my-full-stack-application/api/pulumi/dev/index.ts`
// - `my-full-stack-application/api/pulumi/prod/index.ts`
...
export default {
    commands: {
        async watch(options, context) {
            ...
            Object.assign(
                process.env,
                getStackOutput("my-full-stack-application/api", options.env, MAP)
            );
